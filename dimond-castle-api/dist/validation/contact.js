...
exports.contactSettingsSchema = zod_1.z.object({
    ...
    titleColorEN: zod_1.z.string().optional(),
    titleColorAR: zod_1.z.string().optional(),
    subtitleColorEN: zod_1.z.string().optional(),
    subtitleColorAR: zod_1.z.string().optional(),
    ...
    emails: zod_1.z.array(zod_1.z.string()).default([]),
    addressesEN: zod_1.z.array(zod_1.z.string()).default([]),
    addressesAR: zod_1.z.array(zod_1.z.string()).default([]),
    googleMapEmbedUrl: zod_1.z.string().url().optional().or(zod_1.z.literal('')),
