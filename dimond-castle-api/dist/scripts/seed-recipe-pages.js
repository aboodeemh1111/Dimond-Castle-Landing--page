...
const recipes = [
    {
        ...
        heroIntroEN: "An elevated take on the Gulf classic where every Diamond Castle basmati grain stays long, white, and perfumed.",
        heroIntroAR: "نسخة راقية من الكبسة الخليجية حيث تبقى كل حبة من أرز دايموند كاسل طويلة ولامعة وعابقة.",
        heroBodyEN: "Serve it tableside for celebrations or executive tastings—layers of saffron stock, roasted chicken, and toasted nuts make it unforgettable.",
        heroBodyAR: "قدّمه على المائدة في المناسبات أو جلسات التذوق التنفيذية؛ طبقات مرق الزعفران والدجاج المحمّر والمكسرات المحمصة تترك انطباعاً لا يُنسى.",
        highlightsEN: [
        ...
        tipEN: "Bloom the saffron in hot stock—not boiling water—to preserve its perfume and color.",
        tipAR: "انقع الزعفران في المرق الساخن وليس الماء المغلي لتحافظ على العطر واللون.",
        seoENTitle: "Saffron Majboos Recipe | Diamond Castle Rice",
        seoENDescription: "Step-by-step saffron majboos using Diamond Castle basmati for luxury banquets.",
        seoARTitle: "وصفة كبسة الزعفران بأرز دايموند كاسل",
        seoARDescription: "خطوات تفصيلية لتحضير كبسة فاخرة بخيوط الزعفران وأرز دايموند كاسل البسمتي.",
    },
    {
        slug: "/recipes/citrus-herb-pilaf",
        titleEN: "Charred Citrus & Herb Pilaf",
        titleAR: "بيلاف الأعشاب والحمضيات المحمصة",
        heroIntroEN: "Bright citrus zest and garden herbs cling to every Diamond Castle grain for a refreshing side or light main.",
        heroIntroAR: "قشر الحمضيات الطازج وأعشاب الحديقة تلتصق بكل حبة من أرز دايموند كاسل لطبق جانبي منعش أو طبق رئيسي خفيف.",
        heroBodyEN: "We toast the rice in olive oil, fold in charred lemon, and finish with dill and mint so the platter stays vibrant on any buffet.",
        heroBodyAR: "نحمص الأرز بزيت الزيتون، نضيف شرائح الليمون المحمصة، وننهي بالشبت والنعناع ليبقى الطبق متألقاً على أي بوفيه.",
        highlightsEN: [
        ...
        tipEN: "Char lemons cut-side down until deeply caramelized; the gentle bitterness balances the herbs.",
        tipAR: "حمّر الليمون على الجهة المقطوعة حتى يتكرمل بعمق فمرورته اللطيفة توازن الأعشاب.",
        seoENTitle: "Charred Citrus Herb Pilaf | Diamond Castle Sella",
        seoENDescription: "Vibrant herb pilaf showcasing Diamond Castle Sella rice for buffets and mezze.",
        seoARTitle: "بيلاف الأعشاب والحمضيات بأرز دايموند كاسل سيلا",
        seoARDescription: "طبق جانبي مشرق بالأعشاب والحمضيات مع أرز دايموند كاسل سيلا للمناسبات الفاخرة.",
    },
    {
        ...
        heroIntroEN: "Sweet Gulf shrimp and caramelized tomatoes coat Diamond Castle Jasmine grains for a luxurious seafood machboos.",
        heroIntroAR: "روبيان الخليج الحلو والبندورة المكرملة تغلف حبات أرز دايموند كاسل جاسمين لوصفة مجبوس بحرية فاخرة.",
        heroBodyEN: "The rice steams in shrimp shell stock, absorbing chile, dried limes, and saffron so every bite tastes like the coast.",
        heroBodyAR: "يتبخر الأرز في مرق قشور الروبيان فيمتص الفلفل والليمون المجفف والزعفران لتذوق طعم البحر في كل لقمة.",
        highlightsEN: [
        ...
        tipEN: "Season the shrimp separately with smoked paprika so they stay snappy when steamed.",
        ...
        seoENDescription: "Coastal machboos layered with Diamond Castle Jasmine rice, shrimp stock, and saffron.",
        seoARTitle: "مجبوس روبيان بأرز دايموند كاسل جاسمين",
        seoARDescription: "وصفة مجبوس بحرية بطبقات من الأرز الجاسمين ومرق الروبيان والزعفران.",
    },
    {
        slug: "/recipes/coconut-lime-rice-salad",
        titleEN: "Coconut Lime Celebration Rice Salad",
        titleAR: "سلطة الأرز بجوز الهند والليمون",
        heroIntroEN: "Chilled basmati dressed with coconut milk, lime, and tropical fruit shows how versatile Diamond Castle rice can be.",
        heroIntroAR: "أرز بسمتي مبرد مغطى بحليب جوز الهند والليمون والفواكه الاستوائية يبرز مرونة أرز دايموند كاسل.",
        heroBodyEN: "It feels luxurious yet light—ideal for wellness menus, summer events, or make-ahead corporate lunches.",
        heroBodyAR: "يبدو فاخراً وخفيفاً في آنٍ واحد، مثالي لقوائم العافية أو فعاليات الصيف أو وجبات الشركات الجاهزة.",
        highlightsEN: [
        ...
        occasionEN: "Great for corporate wellness lunches, outdoor buffets, or live cooking stations.",
        occasionAR: "مثالي لغداءات العافية للشركات أو البوفيهات الخارجية أو محطات الطهي الحية.",
        ingredientsEN: [
        ...
        tipEN: "Rinse the rice lightly so a touch of starch remains to emulsify the coconut dressing.",
        tipAR: "اشطف الأرز بسرعة ليبقى قليل من النشاء فيساعد على مزج صلصة جوز الهند.",
        seoENTitle: "Coconut Lime Rice Salad | Diamond Castle",
        seoENDescription: "Cooling coconut-lime rice salad with Diamond Castle basmati, mango, and herbs.",
        seoARTitle: "سلطة أرز جوز الهند والليمون بديموند كاسل",
        seoARDescription: "سلطة مبردة بحليب جوز الهند والليمون والمانجو مع أرز دايموند كاسل البسمتي.",
    },
    {
        slug: "/recipes/smoky-lamb-ouzi",
        titleEN: "Smoky Lamb Ouzi Rice Tray",
        titleAR: "صينية أوزي لحم مدخن",
        heroIntroEN: "Slow-roasted lamb shanks melt into Diamond Castle long-grain rice perfumed with cardamom smoke.",
        heroIntroAR: "سيقان لحم الضأن المشوي ببطء تذوب في أرز دايموند كاسل طويل الحبة المعطر بدخان الهيل.",
        heroBodyEN: "We bake the rice under foil, then finish uncovered for a bronzed top—ready for VIP banquets.",
        heroBodyAR: "نخبز الأرز مغطى ثم نكشفه لنحصل على سطح برونزي جاهز لولائم كبار الشخصيات.",
        highlightsEN: [
        ...
        tipEN: "Rest the tray for 15 minutes before service so the rice reabsorbs the lamb juices.",
        tipAR: "اترك الصينية لترتاح 15 دقيقة قبل التقديم ليعيد الأرز امتصاص عصائر اللحم.",
        seoENTitle: "Smoky Lamb Ouzi Tray | Diamond Castle Rice",
        seoENDescription: "Banquet-ready lamb ouzi baked over Diamond Castle long-grain rice.",
    ...
    },
    {
        ...
        heroIntroEN: "Silky rice pudding layered with rose mascarpone shows Diamond Castle rice in dessert form.",
        heroIntroAR: "مهلبية أرز مخملية بطبقات ماسكاربوني الورد تُظهر جانب الحلوى من أرز دايموند كاسل.",
        heroBodyEN: "We cook the grains low and slow with cardamom, then fold in whipped cream for a glass-ready parfait.",
        heroBodyAR: "نطهو الحبات على نار هادئة مع الهيل ثم نخلطها بالكريمة المخفوقة لتحضير بارفيه جاهز للتقديم.",
        highlightsEN: [
        ...
        occasionEN: "Ideal for afternoon tea towers, Ramadan dessert bars, or retail sampling.",
        occasionAR: "مثالي لأبراج الشاي بعد الظهر أو بارات التحلية الرمضانية أو تذوق المتاجر.",
        ingredientsEN: [
        ...
        tipEN: "Keep the pudding moving with a rubber spatula so the milk never scorches.",
        tipAR: "حرّك المهلبية باستمرار بملعقة سيليكون كي لا يحترق الحليب.",
        seoENTitle: "Cardamom Rose Rice Pudding | Diamond Castle",
        seoENDescription: "Creamy cardamom rice pudding parfait layered with rose mascarpone and pistachios.",
        seoARTitle: "مهلبية أرز بالهيل والورد من دايموند كاسل",
        seoARDescription: "بارفيه أرز مخملي بالهيل وماء الورد مع فستق محمص لبوفيهات الحلويات.",
    },
    {
        slug: "/recipes/crispy-golden-rice-peppers",
        titleEN: "Crispy Peppers Stuffed with Golden Rice",
        titleAR: "فلفل محشي بأرز ذهبي مقرمش",
        heroIntroEN: "Sweet peppers blister in the oven while Diamond Castle rice inside stays fluffy and aromatic.",
        heroIntroAR: "يتفحم الفلفل الحلو في الفرن بينما يبقى أرز دايموند كاسل في الداخل منفوشاً وعطراً.",
        heroBodyEN: "Serve these as premium mezze bites or plated starters—turmeric and saffron give the grains a golden hue.",
        heroBodyAR: "قدّمها كمقبلات فاخرة أو كطبق بداية؛ يمنح الكركم والزعفران الحبات صبغة ذهبية.",
        highlightsEN: [
        ...
        occasionEN: "Great for mezze spreads, catering trays, or vegetarian tasting menus.",
        ...
        tipEN: "Brush the pepper edges with oil to encourage blistering without drying the rice.",
        tipAR: "ادهن حواف الفلفل بالزيت لتتشكل فقاعات الشوي من دون أن يجف الأرز.",
        seoENTitle: "Stuffed Peppers with Diamond Castle Rice",
        seoENDescription: "Golden saffron rice baked inside blistered peppers for mezze or plated starters.",
        seoARTitle: "فلفل محشي بأرز دايموند كاسل الذهبي",
        seoARDescription: "مقبلات فاخرة من فلفل محشو بأرز الزعفران من دايموند كاسل مع حبوب الرمان.",
    },
    {
        slug: "/recipes/mushroom-truffle-rice",
        titleEN: "Wild Mushroom Truffle Rice Skillet",
        titleAR: "مقلاة أرز الفطر البري بالكمأة",
        heroIntroEN: "Earthy mushrooms and truffle oil coat Diamond Castle Sella grains for a luxe vegetarian centerpiece.",
        heroIntroAR: "فطر بري وزيت كمأة يغلفان حبات أرز دايموند كاسل سيلا لطبق نباتي فاخر.",
        heroBodyEN: "Cooked like risotto but finished fluffy, it shows clients how versatile the grains can be.",
        heroBodyAR: "نطهوه مثل الريزوتو ثم نفلّكه ليبقى منفوشاً، لإبراز تعدد استخدام الحبوب.",
        highlightsEN: [
        ...
        occasionEN: "Perfect for modern banquets, chef stations, or plant-forward tastings.",
        occasionAR: "مثالي للولائم العصرية أو محطات الطهاة أو قوائم التذوق النباتية.",
        ingredientsEN: [
        ...
        tipEN: "Warm the stock separately so the rice cooks evenly without turning gluey.",
        tipAR: "احتفظ بالمرق ساخناً في قدر منفصل ليطهى الأرز بالتساوي من دون أن يصبح معجناً.",
        seoENTitle: "Wild Mushroom Truffle Rice | Diamond Castle",
        seoENDescription: "Luxe mushroom and truffle rice skillet built on Diamond Castle Sella grains.",
        seoARTitle: "أرز الفطر البري بالكمأة من دايموند كاسل",
        seoARDescription: "مقلاة أرز نباتية فاخرة بالفطر البري وزيت الكمأة مع أرز دايموند كاسل سيلا.",
    },
    {
        slug: "/recipes/date-almond-breakfast-rice",
        titleEN: "Date & Almond Breakfast Rice Bowls",
        titleAR: "أطباق فطور الأرز بالتمر واللوز",
        heroIntroEN: "A make-ahead breakfast where Diamond Castle rice simmers with almond milk, dates, and tahini.",
        heroIntroAR: "وجبة فطور جاهزة حيث يُطهى أرز دايموند كاسل مع حليب اللوز والتمر والطحينة.",
        heroBodyEN: "Portion into jars for retail or hotel amenities—serve warm with fruit or chilled with yogurt.",
        heroBodyAR: "قسّمه في برطمانات للبيع أو لضيافة الفنادق، وقدمه دافئاً مع الفاكهة أو بارداً مع اللبن.",
        highlightsEN: [
        ...
        occasionEN: "Built for hotel amenities, corporate pantries, or retail sampling.",
        ...
        tipEN: "Blend two of the dates into the almond milk first so sweetness is evenly distributed.",
        tipAR: "اخلط حبتين من التمر مع حليب اللوز بالخلاط أولاً ليتوزع الحلاوة بالتساوي.",
        seoENTitle: "Breakfast Rice Bowls with Dates & Almonds",
        seoENDescription: "Creamy almond-milk rice bowls sweetened with Medjool dates and toasted nuts.",
        seoARTitle: "فطور أرز بالتمر واللوز من دايموند كاسل",
        seoARDescription: "أطباق فطور كريمية بحليب اللوز والتمر واللوز المحمص جاهزة للتقديم أو الحمل.",
    },
    {
        ...
        heroIntroEN: "Roasted zucchini, cauliflower, and green harissa fold through Diamond Castle rice for a plant-forward main.",
        heroIntroAR: "خضار محمصة وهريسة خضراء تمتزج مع أرز دايموند كاسل لطبق نباتي غني.",
        heroBodyEN: "Ideal for modern buffets where color matters—the grains stay bright and separate.",
        heroBodyAR: "مثالي للبوفيهات العصرية حيث يظل اللون أخضر زاهياً والحبات منفصلة.",
        highlightsEN: [
        ...
        occasionEN: "Built for wellness buffets, executive lounges, or retail tastings.",
        ...
        tipEN: "Fold the harissa in while the rice is warm so the herbs release their oils without darkening.",
        tipAR: "أضف الهريسة والأعشاب والأرز لا يزال دافئاً لتطلق زيوتها من دون أن يتغير لونها.",
        seoENTitle: "Green Harissa Vegetable Rice | Diamond Castle",
        seoENDescription: "Plant-forward rice with roasted vegetables, green harissa, and Diamond Castle grains.",
        seoARTitle: "أرز الخضار بالهريسة الخضراء من دايموند كاسل",
        seoARDescription: "طبق نباتي ملون من أرز دايموند كاسل مع خضار محمصة وهريسة خضراء منعشة.",
    },
];
function buildSections(recipe) {
    return [
        {
            key: "hero",
            label: "Hero",
...
async function seedRecipePages() {
    try {
        ...
        for (const recipe of recipes) {
            ...
            const result = await Page_1.default.findOneAndUpdate({ slug: recipe.slug }, payload, {
                upsert: true,
                new: true,
