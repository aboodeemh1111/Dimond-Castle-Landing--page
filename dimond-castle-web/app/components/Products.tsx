export default function Products() {
  ...
  return (
    <section id="products" className="relative py-20 px-6 md:px-12 bg-linear-to-b from-white via-gray-50/30 to-white">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <header className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
            Explore the excellence of White Diamond rice — sourced, processed, and delivered with perfection.
          </p>
        </header>
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-sm text-gray-500">Origin: <span className="font-medium text-gray-700">{product.origin}</span></span>
                </div>
