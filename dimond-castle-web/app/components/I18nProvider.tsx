...
const dictionaries: Dictionaries = {
  en: {
    ...
    "productPage.stock.in": "In Stock",
    "productPage.stock.out": "Out of Stock",
    "productPage.origin": "Origin",
    "productPage.category": "Category",
    "productPage.availableSizes": "Available Sizes",
    "productPage.tags": "Tags",
    "productPage.gallery.heading": "Product Gallery",
    "productPage.gallery.subtitle": "Explore detailed images of",
    "productPage.cta.contact": "Contact Us to Order",
    "productPage.cta.viewAll": "View All Products",
  ...
  ar: {
    ...
    "products.subtitle": "اكتشف تميّز أرز الالماس الابيض — مصدره ومعالجته وتسليمه بإتقان. أرز بسمتي الماس الأبيض الفاخر أجود أنواع أرز البسمتي بحبات طويلة استثنائية ورائحة متفوقة وقوام مثالي.",
    ...
    "productPage.featured": "منتج مميز",
    "productPage.stock.in": "متوفر",
    "productPage.stock.out": "غير متوفر",
    "productPage.origin": "المنشأ",
    "productPage.category": "الفئة",
    "productPage.availableSizes": "الأحجام المتاحة",
    "productPage.tags": "الوسوم",
    "productPage.gallery.heading": "معرض المنتج",
    "productPage.gallery.subtitle": "استكشف صورًا تفصيلية لـ",
    "productPage.cta.contact": "تواصل معنا للطلب",
    "productPage.cta.viewAll": "عرض كل المنتجات",
